...
class MatchSummaryViewController: UIViewController {
    ...
    private func configureTableView() {
        ...
        tableView.register(MatchSummaryTableViewCell.self, forCellReuseIdentifier: MatchSummaryTableViewCell.identifier)
...
extension MatchSummaryViewController: UITableViewDelegate {
    
}

// MARK: - UITableViewDataSource

extension MatchSummaryViewController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return fixtures.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: MatchSummaryTableViewCell.identifier, for: indexPath) as! MatchSummaryTableViewCell
...
extension MatchSummaryViewController: UIScrollViewDelegate {
