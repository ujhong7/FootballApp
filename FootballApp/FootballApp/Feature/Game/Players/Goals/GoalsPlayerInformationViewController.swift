...
class GoalsPlayerInformationViewController: UIViewController {
    ...
    private func setupViewControllers() {
        if let playerID = playerRanking?.player.id {
            let playerProfileVC = PlayerProfileViewController(playerID: playerID)
            let playerStatsVC = PlayerStatsViewController(playerID: playerID)
            let playerTransferVC = PlayerTransferViewController(playerID: playerID)
            viewControllers = [playerProfileVC, playerStatsVC, playerTransferVC]
        }
    }
